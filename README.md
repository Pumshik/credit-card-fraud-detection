...
data/              - исходный csv-файл и разбиение train/test
notebooks/
  1_EDA_and_Preprocessing.ipynb   - загрузка, EDA, масштабирование, разделение
  2_Model_Training_and_Tuning.ipynb - обучение, тюнинг, SHAP-интерпретация
app/
  main.py                          - микросервис FastAPI для инференса
  requirements.txt                 - зависимости сервиса
  best_model.pkl                   - сериализованная модель (из ноутбука 2)
  scaler_amount.pkl                - скейлер для Amount
  scaler_time.pkl                  - скейлер для Time
